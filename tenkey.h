...
#define KC_SPC_NAV_LAYER LT(LAYER_NAV, KC_SPACE)
#define KC_ENT_NUM_LAYER LT(LAYER_NUM, KC_ENTER)
...
#define KM_TEN_BASE_1L KC_W_ALT, KC_F, KC_P_GUI
#define KM_TEN_BASE_2L KC_R_CTL, KC_S_FILL_LEFT, KC_T_SFT
...
#define KM_TEN_BASE_1R KC_L_GUI, KC_U, KC_Y_ALT
#define KM_TEN_BASE_2R KC_N_SFT, KC_E_FILL_RIGHT, KC_I_CTL

#ifdef TENKEY_PINKY_ENABLE
#define KM_TEN_BASE_3R KC_H, KC_COMMA, KC_DOT, KC_O_SYM_RIGHT
#else
#define KM_TEN_BASE_3R KC_H, KC_COMMA, KC_DOT_SYM_RIGHT
#endif
...
#define KM_TEN_THUMB_BASE_L KC_SPC_NAV_LAYER
#define KM_TEN_THUMB_BASE_R KC_ENT_NUM_LAYER
#define KM_TEN_THUMB_BASE KM_TEN_THUMB_BASE_L, KM_TEN_THUMB_BASE_R
#endif

#ifdef TENKEY_FOUR_THUMBKEYS_ENABLE
#define KM_TEN_THUMB_BASE_L KC_OS_SFT, KC_SPC_NAV_LAYER
#define KM_TEN_THUMB_BASE_R KC_ENT_NUM_LAYER, KC_BSPC
#define KM_TEN_THUMB_BASE KM_TEN_THUMB_BASE_L, KM_TEN_THUMB_BASE_R
#endif

#if defined TENKEY_TWO_THUMBKEYS_ENABLE || defined TENKEY_FOUR_THUMBKEYS_ENABLE
#define TENKEY_LAYOUT_BASE KM_TEN_BASE_1, KM_TEN_BASE_2, KM_TEN_BASE_3, KM_TEN_THUMB_BASE_L, KM_TEN_THUMB_BASE_R
#else
#define TENKEY_LAYOUT_BASE KM_TEN_BASE_1, KM_TEN_BASE_2, KM_TEN_BASE_3
#endif

// Left fill layer for ten key keyboards.

#define KM_TEN_FILL_LEFT_1L KC_LALT, KC_NO, KC_LGUI
#define KM_TEN_FILL_LEFT_2L KC_LCTL, KC_TRNS, KC_LSFT
...
#if defined TENKEY_TWO_THUMBKEYS_ENABLE || defined TENKEY_FOUR_THUMBKEYS_ENABLE
#define TENKEY_LAYOUT_FILL_LEFT KM_TEN_FILL_LEFT_1, KM_TEN_FILL_LEFT_2, KM_TEN_FILL_LEFT_3, KM_TEN_THUMB_FILL_LEFT_L, KM_TEN_THUMB_FILL_LEFT_R
#else
#define TENKEY_LAYOUT_FILL_LEFT KM_TEN_FILL_LEFT_1, KM_TEN_FILL_LEFT_2, KM_TEN_FILL_LEFT_3
#endif

// Right fill layer for ten key keyboards.

#define KM_TEN_FILL_RIGHT_1L KC_Q, KC_NO, KC_B
#define KM_TEN_FILL_RIGHT_2L KC_A, KC_TRNS, KC_G
...
#ifdef TENKEY_PINKY_ENABLE
#define KM_TEN_FILL_RIGHT_3R KC_NO, KC_NO, KC_NO, KC_NO
#else
...
#if defined TENKEY_TWO_THUMBKEYS_ENABLE || defined TENKEY_FOUR_THUMBKEYS_ENABLE
#define TENKEY_LAYOUT_FILL_RIGHT KM_TEN_FILL_RIGHT_1, KM_TEN_FILL_RIGHT_2, KM_TEN_FILL_RIGHT_3, KM_TEN_THUMB_FILL_RIGHT_L, KM_TEN_THUMB_FILL_RIGHT_R
#else
#define TENKEY_LAYOUT_FILL_RIGHT KM_TEN_FILL_RIGHT_1, KM_TEN_FILL_RIGHT_2, KM_TEN_FILL_RIGHT_3
#endif
...
#ifdef TENKEY_PINKY_ENABLE
#define KM_TEN_SYM_LEFT_3L KC_A, KC_NO, KC_EQL, KC_SCLN
#else
#define KM_TEN_SYM_LEFT_3L KC_X, KC_EQL, KC_SCLN
#endif
...
#if defined TENKEY_TWO_THUMBKEYS_ENABLE || defined TENKEY_FOUR_THUMBKEYS_ENABLE
#define TENKEY_LAYOUT_SYM_LEFT KM_TEN_SYM_LEFT_1, KM_TEN_SYM_LEFT_2, KM_TEN_SYM_LEFT_3, KM_TEN_THUMB_SYM_LEFT_L, KM_TEN_THUMB_SYM_LEFT_R
#else
#define TENKEY_LAYOUT_SYM_LEFT KM_TEN_SYM_LEFT_1, KM_TEN_SYM_LEFT_2, KM_TEN_SYM_LEFT_3
#endif
...
#ifdef TENKEY_PINKY_ENABLE
#define KM_TEN_SYM_RIGHT_3R KC_RPRN, KC_GT, KC_NO, KC_O
#else
#define KM_TEN_SYM_RIGHT_3R KC_RPRN, KC_GT, KC_DOT
#endif
...
#if defined TENKEY_TWO_THUMBKEYS_ENABLE || defined TENKEY_FOUR_THUMBKEYS_ENABLE
#define TENKEY_LAYOUT_SYM_RIGHT KM_TEN_SYM_RIGHT_1, KM_TEN_SYM_RIGHT_2, KM_TEN_SYM_RIGHT_3, KM_TEN_THUMB_SYM_RIGHT_L, KM_TEN_THUMB_SYM_RIGHT_R
#else
#define TENKEY_LAYOUT_SYM_RIGHT KM_TEN_SYM_RIGHT_1, KM_TEN_SYM_RIGHT_2, KM_TEN_SYM_RIGHT_3
#endif
...
#define KM_TEN_NAV_1R LCTL(LGUI(KC_LEFT)), KC_UP, LCTL(LGUI(KC_RGHT))
#define KM_TEN_NAV_2R KC_LEFT, KC_DOWN, KC_RGHT
...
#if defined TENKEY_TWO_THUMBKEYS_ENABLE || defined TENKEY_FOUR_THUMBKEYS_ENABLE
#define TENKEY_LAYOUT_NAV KM_TEN_NAV_1, KM_TEN_NAV_2, KM_TEN_NAV_3, KM_TEN_THUMB_NAV_L, KM_TEN_THUMB_NAV_R
#else
#define TENKEY_LAYOUT_NAV KM_TEN_NAV_1, KM_TEN_NAV_2, KM_TEN_NAV_3
#endif
...
#if defined TENKEY_TWO_THUMBKEYS_ENABLE || defined TENKEY_FOUR_THUMBKEYS_ENABLE
#define TENKEY_LAYOUT_NUM KM_TEN_NUM_1, KM_TEN_NUM_2, KM_TEN_NUM_3, KM_TEN_THUMB_NUM_L, KM_TEN_THUMB_NUM_R
#else
#define TENKEY_LAYOUT_NUM KM_TEN_NUM_1, KM_TEN_NUM_2, KM_TEN_NUM_3
#endif
...
#if defined TENKEY_TWO_THUMBKEYS_ENABLE || defined TENKEY_FOUR_THUMBKEYS_ENABLE
#define TENKEY_LAYOUT_FUNC KM_TEN_FUNC_1, KM_TEN_FUNC_2, KM_TEN_FUNC_3, KM_TEN_THUMB_FUNC_L, KM_TEN_THUMB_FUNC_R
#else
#define TENKEY_LAYOUT_FUNC KM_TEN_FUNC_1, KM_TEN_FUNC_2, KM_TEN_FUNC_3
#endif
