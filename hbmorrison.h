...
#define KM_BASE_1L KC_Q, KC_W_ALT, KC_F, KC_P_GUI, KC_B
#define KM_BASE_2L KC_A, KC_R_CTL, KC_S, KC_T_SFT, KC_G
#define KM_BASE_3L KC_Z, KC_X, KC_C, KC_D, KC_V

#define KM_BASE_1R KC_J, KC_L_GUI, KC_U, KC_Y_ALT, KC_BSPC
#define KM_BASE_2R KC_M, KC_N_SFT, KC_E, KC_I_CTL, KC_O
#define KM_BASE_3R KC_K, KC_H, KC_COMM, KC_DOT, OSL(LAYER_SCUT)
...
#define KM_BASE_THUMB_R KC_ENT_NUM, OSL(LAYER_SYM)
...
#define KM_NAV_3L KC_CAPS, NC_MPRV, KC_MUTE, KC_NO, KC_NO

#define KM_NAV_1R M_XTAB, M_PDESK, KC_CTL_TAB, M_ALT_TAB, M_NDESK
#define KM_NAV_2R KC_WH_UP, KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT
#define KM_NAV_3R KC_WH_DN, KC_HOME, KC_PGDN, KC_PGUP, KC_END
...
#define KM_SCUT_1L M_ISWIN, M_ISCROS, KC_NO, KC_NO, KC_NO
#define KM_SCUT_2L M_APP1, M_APP2, M_APP3, M_APP4, M_APP5
#define KM_SCUT_3L KC_NO, KC_NO, KC_NO, KC_NO, KC_NO
...
#define LAYOUT_SCUT_THUMB KC_NO, KC_NO, KC_NO, KC_NO
...
#define KM_PLANCK_BASE_2 KC_TAB, KM_BASE_2L, KM_BASE_2R, KC_SFT_TAB
#define KM_PLANCK_BASE_3 KC_CAPS, KM_BASE_3L, KM_BASE_3R, KC_SCUT

#define KM_PLANCK_BASE_THUMB KC_LSFT, KC_LCTL, KC_LALT, KC_LGUI, KM_BASE_THUMB_L, KM_BASE_THUMB_R, KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT
...
#define KM_PLANCK_SYM_THUMB KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
...
#define KM_PLANCK_NAV_THUMB KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KM_NAV_THUMB_L, KM_NAV_THUMB_R, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
...
#define KM_PLANCK_NUM_THUMB KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KM_NUM_THUMB_L, KM_NUM_THUMB_R, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
...
#define KM_PLANCK_SCUT_THUMB KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
