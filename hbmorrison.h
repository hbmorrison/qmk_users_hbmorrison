...
#define KM_LSYM_2L KC_NO, KC_GRV, KC_LBRC, KC_LCBR, KC_LPRN
#define KM_LSYM_3L KC_NO, KC_UK_HASH, KC_RBRC, KC_RCBR, KC_RPRN
...
#define KM_LSYM_THUMB KC_TRNS, KC_TRNS, KC_UK_PIPE, KC_UK_BSLS
