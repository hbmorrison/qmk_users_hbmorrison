...
#define KM_BASE_3L KC_Z_RSYM, KC_X_GUI, KC_C_ALT, KC_D_CTL, KC_V_CA

#define KM_BASE_1R KC_J, KC_L, KC_U_CTRL, KC_Y, KC_BSPC
#define KM_BASE_2R KC_M, KC_N, KC_E, KC_I, KC_O
#define KM_BASE_3R KC_K_CA, KC_H_CTL, KC_COMMA_ALT, KC_DOT_GUI, KC_SLSH_LSYM
